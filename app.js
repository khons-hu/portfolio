...
const projects = {
  market: { title: 'Market Watch', category: 'CURRENT PROJECT · JAVASCRIPT / PUBLIC DATA', description: 'A read-only desk for Polymarket wallet research.', notes: ['Leaderboard filters, wallet positions, activity, watchlists and local notes. Published rankings are a starting point for research, not proof of repeatable returns.', 'Trade alerts work while the page is open. The AI company notebook links official news and SEC searches, without claiming any IPO date.', 'No wallet connection or trading. Live upstream data still needs verification from the deployed environment.'], url: 'https://github.com/khons-hu/market-watch' },
  signal: { title: 'Quiet Signal', category: 'CURRENT PROJECT · TYPESCRIPT / RSS', description: 'A small inbox for AI updates, without the endless feed.', notes: ['Official OpenAI and DeepMind news, coding-tool releases, service status, combined RSS and OPML export.', 'Save links, mark updates read and choose what matters. The importance labels explain their rules. Tibo’s X account is linked directly, not automatically monitored.', 'The source is public. Hosted notifications need a separate free-service setup and are not yet verified.'], url: 'https://github.com/khons-hu/quiet-signal' },
  thinkroom: { title: 'Thinkroom', category: 'CURRENT PROJECT · JAVASCRIPT / BROWSER SANDBOX', description: 'A small practice workshop for thinking through problems yourself.', notes: ['Fifteen original exercises across coding, debugging, logic, prompt design and agent skills. Write an approach, try it, reveal hints gradually, and reflect.', 'JavaScript, TypeScript and Python sample checks run locally with a time limit. C and C++ have an experimental local compiler for running full programs. Go has saved drafts, downloads and an external playground link. Written exercises use self-review checklists.', 'Free to use, with public source code. No account or paid AI calls.'], url: 'https://github.com/khons-hu/thinkroom' },
...
function showProject(id) {
  ...
  link.textContent = project.live ? 'Open app ↗' : 'View source on GitHub ↗';
