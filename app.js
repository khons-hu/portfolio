...
const projects = {
  discovery: { title: 'Discovery routines', category: 'PERSONAL EXPERIMENT · SCHEDULED CODEX WORKFLOWS', description: 'A small set of weekly workflows for finding people whose work I want to follow.', notes: ['On X, the workflow prepares relevant account and notification recommendations. On GitHub, it is configured to follow up to three relevant developers per week after checking their projects and existing follows.', 'The topics include C++, developer tools, coding agents, AI research and CS2 tools. Each run is bounded, with duplicate checks and a short explanation of each selection.', 'These are configured Codex workflows, not a standalone app or a zero-token script. The first scheduled run has not yet been verified.'] },
