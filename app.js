...
const projects = {
  ...
  rotation: {"title": "Spotify rotation", "category": "PERSONAL EXPERIMENT · PYTHON / SPOTIFY API", "description": "A personal rotation and mood playlists on request. Built locally with Python.", "playlist": "https://open.spotify.com/playlist/3TT6VlZMa8kB3aGCsIulV8?si=c600bcff64164b14", "linkLabel": "Open playlist ↗", "linkKind": "external", "notes": ["A local Python script builds a private rotation from favourites and recent listening, without recurring AI calls.", "On request, it also searches by mood, activity or artist and favours familiar artists in the results. Mood matching is approximate, not audio analysis.", "The playlist is saved privately and checked after writing. This is a personal tool running on my Mac. The source is not published."]},
