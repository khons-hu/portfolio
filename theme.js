...
(function(){
 ...
 document.addEventListener('DOMContentLoaded',()=>{
  ...
  document.querySelector('#theme-toggle').addEventListener('click',()=>{saved=document.documentElement.dataset.theme==='light'?'dark':'light';try{localStorage.setItem('khonsu-theme',saved);}catch{}apply(saved);});
 });
})();
